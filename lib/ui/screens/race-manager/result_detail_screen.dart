...
class ResultDetailScreen extends StatefulWidget {
  final String raceId;
  const ResultDetailScreen({Key? key, required this.raceId}) : super(key: key);
...
class _ResultDetailScreenState extends State<ResultDetailScreen> {
  ...
  Future<void> _loadResults() async {
    ...
    final List<ParticipantItem> parts = context.read<ParticipantProvider>().participants;
    ...
    for (var p in parts) {
      ...
      final total = times.fold<int>(0, (sum, t) => sum + t.elapsedTimeInSeconds);
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (ctx, i) {
                    ...
                    return ListTile(
                      ...
                      trailing: Text(timestr, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 11)),
                    );
                  },
                ),
              ),
